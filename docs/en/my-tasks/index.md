...
When working with the SCM-Manager, it is quite possible some tasks may appear. For example, 
when the scm-review-plugin is installed, reviewers can create tasks on open pull requests. 
This way, they can express their change requests. 
