...
public class MyEventResource {
  ...
  @Operation(
    summary = "'My Events'",
    description = "Returns latest events relevant for the current user",
    tags = "Landingpage Plugin",
    operationId = "landingpage_my_events"
  )
  @ApiResponse(
    responseCode = "200",
    description = "success",
    content = @Content(
      mediaType = MEDIATYPE,
      schema = @Schema(implementation = MyEventDto.class)
    )
  )
