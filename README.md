...
This plugin creates a personal landingpage for each user.

## Usage

Find out how this plugin can be used on the [user documentation page](https://scm-manager.org/plugins/scm-landingpage-plugin/docs).
